...
const SampleContent = ({
  ...
  >
    ...
    >
      This is sample content inside the floater component.
    </Text>
  </View>
)
...
export const LongContent: Story = {
  args: {
    children: (
      <View
        style={{ padding: 20, backgroundColor: '#007AFF', borderRadius: 12 }}
      >
        <Text
          style={{
            color: 'white',
        ...
        >
          This is a longer piece of content that demonstrates how the Floater
          component handles text that might wrap to multiple lines. The content
          should be properly contained within the floater's maximum width
          constraints.
        </Text>
        <Text
          style={{
        ...
        >
          Additional paragraphs can be added here to show how the component
          handles multiple text blocks and maintains proper spacing.
        </Text>
      </View>
    ),
  },
    ...
    children: (
      <View style={{ gap: 15 }}>
        ...
        >
          ...
          <Text style={{ color: 'white', fontSize: 14, marginTop: 5 }}>
            This section contains the main content with multiple elements.
          </Text>
        </View>
