  ...
  render: () => (
    <View style={{ gap: 20 }}>
      <View>
        ...
        <Row variant="start" style={{ height: 80, backgroundColor: '#f0f0f0', padding: 10 }}>
          <SampleItem text="Item 1" />
          <SampleItem text="Item 2" color="#34C759" />
          <SampleItem text="Item 3" color="#FF9500" />
        </Row>
      ...
      <View>
        ...
        <Row variant="end" style={{ height: 80, backgroundColor: '#f0f0f0', padding: 10 }}>
          <SampleItem text="Item 1" />
          <SampleItem text="Item 2" color="#34C759" />
          <SampleItem text="Item 3" color="#FF9500" />
        </Row>
      ...
      <View>
        ...
        <Row variant="spaced" style={{ height: 80, backgroundColor: '#f0f0f0', padding: 10 }}>
          <SampleItem text="Item 1" />
          <SampleItem text="Item 2" color="#34C759" />
          <SampleItem text="Item 3" color="#FF9500" />
        </Row>
      ...
      <View>
        <Text style={{ marginBottom: 10, fontWeight: 'bold' }}>Center Variant</Text>
        <Row variant="center" style={{ height: 80, backgroundColor: '#f0f0f0', padding: 10 }}>
          <SampleItem text="Item 1" />
          <SampleItem text="Item 2" color="#34C759" />
          <SampleItem text="Item 3" color="#FF9500" />
        </Row>
