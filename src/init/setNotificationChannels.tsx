...
setNotificationChannelAsync('default', {
  ...
  captureNotificationException(
    'Failed to assign Miscellaneous notification channel:',
    e
  )
)
...
setNotificationChannelAsync('event_reminders', {
  ...
  captureNotificationException(
    'Failed to assign Event Reminders notification channel:',
    e
  )
)
...
setNotificationChannelAsync('announcements', {
  ...
  captureNotificationException(
    'Failed to assign Announcements notification channel:',
    e
  )
)
...
setNotificationChannelAsync('private_messages', {
  ...
  captureNotificationException(
    'Failed to assign Private Messages notification channel:',
    e
  )
)
