...
import {
  dealersFullCollection,
  type EfDealerFull,
} from '@/data/collections/content/DealersFull'
...
export function DealersView({
  ...
  return (
    <EfSectionList<string, EfDealerFull>
      ...
      renderSection={({ item }) => {
        return (
          <DealerSection
            ...
            title={
              item === ''
                ? t('section_table_none')
                : t('section_table', { section: item })
            }
