...
export const ArtistsAlleyStatus = ({
  data,
  onEdit,
  onCheckOut,
  onCancel,
  ...
  return (
    <View>
      <Label
        ...
        accessibilityLabel={`Current status: ${statusText}`}
      >
        {statusText}
      </Label>
      {data.State === 'Accepted' ? (
        <Button
          onPress={onCheckOut}
          icon='exit-run'
          accessibilityLabel={tAccessibility('checkout_button')}
          accessibilityHint={tAccessibility('checkout_button_hint')}
        >
          {t('check_out')}
        </Button>
      ) : (
        <Button
          ...
          accessibilityLabel={
            data.State === 'Pending'
              ? tAccessibility('edit_button')
              : tAccessibility('new_request_button')
          }
          accessibilityHint={
            data.State === 'Pending'
              ? tAccessibility('edit_button_hint')
              : tAccessibility('new_request_button_hint')
          }
        >
      ...
      {data.State === 'Pending' ? (
        <Button
          onPress={onCancel}
          className='mt-3'
          accessibilityLabel={tAccessibility('cancel_button')}
          accessibilityHint={tAccessibility('cancel_button_hint')}
        >
          {t('cancel_request')}
        </Button>
      ) : null}
