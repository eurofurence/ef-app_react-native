...
const Tab = ({ icon, text, indicate, active, onPress }) => {
    return (
        <TouchableOpacity containerStyle={styles.tabContainer} style={styles.tab} hitSlop={16} onPress={onPress}>
                ...
                {!indicate ? null : (
                    <View style={styles.indicatorArea}>
                        <View style={styles.indicatorLocator}>
                            <View style={styles.indicatorContent}>{indicate === true ? null : indicate}</View>
                        </View>
                    </View>
                )}
            </View>
