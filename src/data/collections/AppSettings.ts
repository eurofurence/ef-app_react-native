import { BasicIndex, createCollection, localStorageCollectionOptions, useLiveQuery, WritableDeep } from "@tanstack/react-db";
import { EfAppSettings } from "@/data/types/EfAppSettings";
...
export function appSettingsUpdate(callback: (draft: WritableDeep<EfAppSettings>) => void) {
  // Update existing.
